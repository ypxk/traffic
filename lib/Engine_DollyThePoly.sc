		...
		this.addCommand(\noteOn, "iff", { arg msg;
			...
			context.server.makeBundle(nil, {
				newVoice = (id: id, theSynth: Synth.new(defName: \voice, args: [
					...
					\lastFreq, lastFreq,
					\glide, glide,
					\mainOscLevel, mainOscLevel * rrand(0.7,1.2),
					...
					\lfoFade, lfoFade,
					\env1Attack, env1Attack * rrand(0.1,1.9),
					\env1Decay, env1Decay * rrand(0.1,1.9),
					\env1Sustain, env1Sustain * rrand(0.1,1.9),
					\env1Release, env1Release * rrand(0.1,1.9),
					\env2Attack, env2Attack * rrand(0.1,1.9),
					\env2Decay, env2Decay * rrand(0.1,1.9),
					\env2Sustain, env2Sustain * rrand(0.1,1.9),
					\env2Release, env2Release * rrand(0.1,1.9),
					\ampMod, ampMod,
